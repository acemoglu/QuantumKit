...
extension QuantumCircuit {
    ...
    mutating func applyMAJ(_ c: Int, _ b: Int, _ a: Int) throws {
        try cx(a, b)
        try cx(a, c)
        try ccx(c, b, a)
    }
    ...
    mutating func applyUMA(_ c: Int, _ b: Int, _ a: Int) throws {
        try ccx(c, b, a)
        try cx(a, c)
        try cx(c, b)
    }
    ...
    mutating func applyControlledMAJ(
    ...
    mutating func applyControlledUMA(
        ctrl: Int, c: Int, b: Int, a: Int, ancilla: Int
    ) throws {
    ...
    mutating func applyQuantumAddWrapping(
    ...
    mutating func applyQuantumSubtractWrapping(
        registerA: [Int], registerB: [Int], carryIn: Int
    ) throws {
        let n = registerA.count
    ...
    mutating func applyControlledQuantumAddWrapping(
    ...
    mutating func applyControlledQuantumSubtractWrapping(
        control: Int, registerA: [Int], registerB: [Int], carryIn: Int, ancilla: Int
    ) throws {
        let n = registerA.count
